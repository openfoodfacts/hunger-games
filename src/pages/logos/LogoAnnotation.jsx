  ...
  return (
    <Box sx={{ margin: "2% 10%" }}>
      ...
      <ol>
        ...
        <li>
          You can only select Logos which are <strong>NOT</strong> highlighted
          in grey
        </li>
        <li>
          After the selection, in the 'Value' box below fill the common value in
          all logos.{" "}
        </li>
        <li>
          Proceed and select the 'Type' box with the type of value you have
          filled{" "}
        </li>
